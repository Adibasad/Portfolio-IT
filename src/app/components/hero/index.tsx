    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-16 bg-gray-700/30 w-[90%] md:w-3/4 h-full text-offwhite px-8 py-10 mt-30 rounded-2xl z-10">
      <div className="main-text-container w-full md:w-2/3">
        ...
        >
          ...
          with over a year of experience in building and deploying{" "}
          scalable web applications. I
          specialize in crafting dynamic,responsive, and{" "}
          user-friendly interfaces while
          ensuring seamless data managemen.
          With a keen eye for <span className="font-semibold">design</span> and{" "}
          <span className="font-semibold">performance</span>, I create intuitive{" "}
        digital experiences that bring
          ideas to life.
        </motion.p>
